...
void escreverCSVCli(FILE *file2, struct clientes dados[], int numDados)
{
    ...
    {
        fprintf(file2, "%s,%s,%s,%s,%f,%d,%d,%d,%d,%s,%d\n",
                ...
                dados[i].estadoCli, dados[i].nota);
    }
}

void lerCSVCli(FILE *file2, struct clientes dados[], int *numDados)
{
    char linha[max_str_length * 11];
    sscanf(linha, "%49[^,],%49[^,],%49[^,],%49[^,],%f,%d,%d,%d,%d,%49[^,],%d",
           ...
           dados[*numDados].estadoCli, dados[*numDados].nota,
...
int main()
{
    ...
    if (file != NULL)
    { /*basicamente pra ver se o csv esta funciondo, onde ai diz se diferente de 0/null/negativo/desligado*/
    ...
    while (1)
    {
        ...
        case 6:
            ...
            if (registroEdicaoF >= 1 && registroEdicaoF <= numRecord)
            { // verifica se o numero dado esta dentro da lista de registros disponiveis
        ...
        case 8:
            ...
            float percentTeen = visitantesTeen/numDados * 10;
            float percentAdults = visitantesAdult/numDados * 10;
            float percentOld = visitantesOld/numDados * 10;
